...
?>
<title>PHẦN MỀM QUẢN LÝ BỆNH VIỆN</title>
</head>
<body>
	<?php
		if((isset($_GET["login"]))){
	...
	<div class="header_form theme_color">
    	<div id="header_main2">
				...
				<div class="user-info  theme_color" style="float:left; width:12%; padding-right:1px; text-align:right; height:22px; background:#46997D;padding-top: 6px; color:#fff; text-transform:uppercase;">
				Xin chào: <?=$_SESSION["user"]["nickname"];?> | <a href="http://<?=$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']?>?login=false" class="btn-logout">Thoát</a>
				</div>
         </div>
    </div>
