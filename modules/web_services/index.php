...
?>
 <?php
          ...
          <div class="profile_container">
            ...
            <span id="panel_tenbn" class="texts" style="width:180px"><?=$HoLotBenhNhan?></span><!--23/12/15 Nam edit bo important vi cac form goi ham nay khong the custom duoc CSS theo y muon -->
        </div>
        <div class="profile_container">
...
?>
 <?php
          ...
          <div class="profile_container">
            ...
            <span id="panel_tenbn" class="texts" style="width:180px !important"><?=$HoLotBenhNhan?></span>
        </div>
        <div class="profile_container">
             <span class="addon" href="#" style="padding-left:4px; padding-right:4px;">
                <i class="fa fa-female icon"></i>
        ...
        <div class="profile_container">
      <!--        <span class="addon" href="#" style="">
              <i class="icon fa"><span>ĐT</span></i>
            </span> -->
...
<script>
	...
	function moghichu(){
	elem = 1 + Math.floor(Math.random() * 1000000000);
	dialog_main("Ghi chú của bệnh nhân: <?=$HoLotBenhNhan?>", 95, 70, elem, 'resource.php?module=hanhchinh&view=ghi_chu&id_form=230&idbenhnhan=<?=$id_benhnhanP?>');
}
	</script>
