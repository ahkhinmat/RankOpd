...
<body>
	<div  class="container col-md-12 none-pad-mar" style="padding:10px;">
		...
		<div class="col-md-12 none-pad-mar" style="margin-top: 10px;border:;">
...
<script type="text/javascript" >
	...
	jQuery(function($) {
		...
		jQuery(grid_selector2).jqGrid({
			...
			height: 380,
			width:380,
			colNames:['idXepHang','STT', 'Số phiếu','Trạng thái','Ngày giờ'],
			colModel:[
			{name:'idXepHang',index:'idXepHang', width:100, hidden: true},
			{name:'STT',index:'STT', width:100, hidden: true},
			{name:'SoXepHang',index:'SoXepHang', width:100},
			{name:'TenTrangThai',index:'TenTrangThai', width:100},
			{name:'NgayGio',index:'NgayGio', width:100}
			],
			loadonce: true,
			rowNum:1000,
			rowList:[10,20,30],
